...
public class HaloDrive extends CommandBase {
    ...
    public void execute() {
        double finesse = 0;
        if (RobotContainer.getInstance().getdriverJoystick().getAButtonPressed()){finesse = .5;}
        double leftSpeed = finesse * -1*RobotContainer.getInstance().getdriverJoystick().getRawAxis(1);
        double rightSpeed = -1*RobotContainer.getInstance().getdriverJoystick().getRawAxis(5);
