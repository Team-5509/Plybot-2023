...
private final XboxController driverJoystick = new XboxController(1);
  ...
  */
  private RobotContainer() {
    ...
    SmartDashboard.putData("RunWrist", new RunWrist( false, m_clawWrist ));
    ...
    m_clawWrist.setDefaultCommand(new RunWrist(false, m_clawWrist));
...
// Create some buttons
final JoystickButton button_RunWrist = new JoystickButton(driverJoystick, XboxController.Button.kX.value);        
button_RunWrist.toggleOnTrue(new RunWrist(true, m_clawWrist).withInterruptBehavior(InterruptionBehavior.kCancelSelf));
