...
// The robot's subsystems
    public final LimitSwitches m_limitSwitches = new LimitSwitches();
...
private final XboxController driverJoystick = new XboxController(1);
  ...
  */
  private RobotContainer() {
    ...
    SmartDashboard.putData("SwitchHit", new SwitchHit( m_limitSwitches ));
    ...
    m_limitSwitches.setDefaultCommand(new SwitchHit( m_limitSwitches ));
